...
namespace ContosoUniversity.Controllers
{
    public class CoursesController : BaseController
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (teachingMaterialImage != null && teachingMaterialImage.Length > 0)
                {
                    ...
                    try
                    {
                        ...
                        var uploadsPath = Path.Combine(webHostEnvironment.WebRootPath, "Uploads", "TeachingMaterials");
            ...
            if (ModelState.IsValid)
            {
                ...
                if (teachingMaterialImage != null && teachingMaterialImage.Length > 0)
                {
                    ...
                    try
                    {
                        ...
                        {
                            var oldFilePath = Path.Combine(webHostEnvironment.WebRootPath, course.TeachingMaterialImagePath.TrimStart('/'));
        ...
        public IActionResult DeleteConfirmed(int id)
        {
            ...
            if (!string.IsNullOrEmpty(course.TeachingMaterialImagePath))
            {
                var filePath = Path.Combine(webHostEnvironment.WebRootPath, course.TeachingMaterialImagePath.TrimStart('/'));
