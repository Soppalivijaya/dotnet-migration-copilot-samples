...
namespace ContosoUniversity.Controllers
{
    public class InstructorsController : BaseController
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(int? id, [Bind("ID,FirstMidName,LastName,HireDate")] Instructor instructor, string[] selectedCourses)
        {
            if (id == null)
            {
                return BadRequest();
            ...
            // Update basic instructor properties
            ...
            try
            {
                // Handle office assignment - clear if location is empty
